...
onMounted(async () => {
  try {
    ...
    const responseMovie = await axios.get(`https://movieapi.camelientrn.fr/api/movies/${movieId}`);
...
const updateMovie = async () => {
  try {
    const response = await axios.patch(`https://movieapi.camelientrn.fr/api/movies/${movie.value.id}`, {
...
const deleteMovie = async () => {
  try {
    const response = await axios.delete(`https://movieapi.camelientrn.fr/api/movies/${movie.value.id}`);
